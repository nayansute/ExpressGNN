...
file_path1 = "./kinship_results/GAT/" + str(args.arg1)  # Replace 'your_file_path.csv' with the actual file path
file_path2 = "./kinship_results/GIN/" + str(args.arg2)
file_path3 = "./kinship_results/Original/" + str(args.arg3)
